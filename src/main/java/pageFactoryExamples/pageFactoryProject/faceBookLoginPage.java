...
public class faceBookLoginPage extends AbstractPage {
	...
	WebElement emailFieldElement; // this could be used in the actual TC. However; an explicit wait, above it, targetting this web element
	                        ...
	                        // method [becasue this called method = the returned value = emailFiedBox = driver.findElement() ]
	...
	By locatorForPasswordField = By.id("pass");
	...
	// attention: emailFieldElement.sendKeys(email); works but won't include the explicit wait step above it targetting the email field !
