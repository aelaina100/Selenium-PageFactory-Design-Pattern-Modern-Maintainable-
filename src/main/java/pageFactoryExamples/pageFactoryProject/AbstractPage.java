...
public class AbstractPage 
{
	...
	public void waitForEmailFieldToAppear(WebDriver driver, By locatorForEmailBox)
	{
	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
	wait.until(ExpectedConditions.visibilityOfElementLocated(locatorForEmailBox));
	}
