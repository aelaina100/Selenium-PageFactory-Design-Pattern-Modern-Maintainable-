...
public class faceBookLogin {
	...
	object.goTo("https://www.facebook.com/"); // in real-time the URL value is fed to the test case from ..(same comment below)
	
	/* Normally, the next line should be:
	 * 
	 * driver.findElement(By.cssSelector("")).sendKeys(""); 
	 * 
	 * However; in real-time locators (Plus synchronization) need to be fed to the testcase from a page object or page factory .java class file.
	...
	object.emailFieldElement.clear(); //as opposed to: emailField().clear cuz script already waited for visibility of the email field.
